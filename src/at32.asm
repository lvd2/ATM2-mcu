;************************************************
; Контроллер AT-клавиатуры на 52-ом контроллере *
; Версия 4.1  для схемы с исправленным RESET	*
...
en_movx	equ	0	;1 - разрешена movx
;0 - прямое управление
; разрешение работы с прерыванием
en_int	equ	1	;0 - не разрешен
;------------------------------------------
...
;**********************************************
t_60	equ	60*4	;60 мсек (40*0.25 мсек)
...
; Пауза 10 мсек
del_60ms:
	mov	R1,#t_60 	;Константа для 60 мсек
